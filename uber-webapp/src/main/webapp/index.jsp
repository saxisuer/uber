...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<div region="north" split="true" border="false"
		...
		</span><span style="padding-left:180px; padding-top:2px ; font-size: 16px; background: url(<%=path%>/public/uber/logo2.png) no-repeat 2px 3px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
	</div>
	...
	<div region="south" split="true"
		...
		<div class="footer"><div style="float:right;">登录用户[<s:property value="#session.userinfo.cnname"/>]</div></div>
	</div>
		...
		<div class="easyui-layout" fit="true">
			<div region="center" border="false"
				...
				<table cellpadding=3>
					<tr>
						<td>旧密码：</td>
						<td><input id="txtOriPass" type="Password" class="easyui-textbox" ></input></td>
					</tr>
					<tr>
						<td>新密码：</td>
						<td><input id="txtNewPass" type="Password" class="easyui-textbox" ></input></td>
					</tr>
					<tr>
						<td>确认密码：</td>
						<td><input id="txtRePass" type="Password" class="easyui-textbox" ></input></td>
					</tr>
				</table>
			</div>
	...
	<!-- 弹窗模板 -->
	<div id="wUpdate" class="easyui-window" title="更新数据" data-options="modal:true,closed:true,iconCls:'icon-save',minimizable:false,maximizable:false,collapsible:false" style="width:600px;height:400px;padding:5px;">
	...
	<div id="loginMask" class="window-mask loading-mask" style="width: 100%; height: 100%; display: block; z-index: 9002;"><div class="tips">正在加载中...</div></div>
</body>
<script>
