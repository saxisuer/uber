        ...
        <div class="yui3-g">
            <div class="yui3-u-1-2">
                <div class="formgourp">
                    <label>设备名称：</label>
                    <div class="textbox">
                        <input id="groupName" class="textbox-text easyui-validatebox textbox-prompt" name="groupName"/>
                    </div>
                </div>
                <div class="formgourp">
                    <label>设备备注：</label>
                    <div class="textbox">
                        <input id='groupDesc' class="textbox-text validatebox-text textbox-prompt" name="groupDesc"/>
                    </div>
                </div>
                <div class="formgourp">
                    <label>所属城市：</label>
