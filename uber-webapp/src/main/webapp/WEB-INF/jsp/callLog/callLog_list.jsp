  ...
  <body id="body">
	...
	<div id="search" class="easyui-panel" style="padding:5px;margin-bottom:2px;" >
		<table cellpadding="1px;" style="font-size:11px;">
	    		<tr>
	    			<td>设备ID</td>
	    			<td><input class="easyui-textbox" type="text" id="param_uuid" ></input></td>
	    			<td>帐号</td>
	    			<td><input class="easyui-textbox" type="text" id="param_userAcc" ></input></td>
	    			<td>车卡号</td>
	    			<td><input class="easyui-textbox" type="text" id="param_cardNoPhisycal" ></input></td>
	    		</tr>
	    		<tr>
	    			<td>叫车时间</td>
	    			<td><input id="param_callTime" class="easyui-datebox" ></input></td>
	    			<td>司机到达时间</td>
	    			<td><input id="param_pickupTime" class="easyui-datebox" ></input></td>
...
function search(){
	$('#callLog').datagrid('load',{ param_uuid: $.trim($('#param_uuid').val()),
