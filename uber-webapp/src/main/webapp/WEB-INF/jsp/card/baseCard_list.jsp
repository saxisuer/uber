...
<!-- 表格顶部工具栏 -->
<div id="toolbar">
    <form class="import-form" action="${ctx}/baseCard/baseCardfileUpload" method="post" enctype="multipart/form-data">
    ...
    $(function () {
        ...
        $("#delete").on("click", function () {
            ...
            $.messager.confirm('提醒', '您确定要删除吗？', function (e) {
                if (e) {
                    deleteBaseCard({
                        action: '${ctx}/baseCard/delete/' + r.id,
                        id: {'id': r.id}
                    });
                }
            });
