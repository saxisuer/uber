        ...
        <div class="yui3-g">
            <div class="yui3-u-1-2">
                ...
                <div class="formgourp">
                    <label>姓名：</label>
                    <div class="textbox">
                        <input class="textbox-text validatebox-text textbox-prompt" name="cnname"/>
                    </div>
                </div>
                <div class="formgourp">
                    <label>密码：</label>
                    <div class="textbox">
                        <input id="pwd" class="textbox-text validatebox-text textbox-prompt" type="password" name="password"/>
                    </div>
                </div>
                <div class="formgourp">
                    <label>状态：</label>
                    <div class="textbox">
                        <select class="easyui-combobox" name="status" data-options="required:true">
                            ...
                            <option value="0"
                                    <c:if test="user.status==0">selected="selected"</c:if>>禁用
                            </option>
                        </select>
                    </div>
                </div>
