    ...
    <div class="user-form">
        ...
        <div class="yui3-g">
            <div class="yui3-u-1-2">
                ...
                <div class="formgourp">
                    <label>姓名：</label>
                    <div class="textbox"><input class="textbox-text validatebox-text textbox-prompt" name="user.cnname"
                                                value="<s:property value="user.cnname"/>"></div>
                </div>
                <div class="formgourp hide">
                    <label>密码：</label>
                    <div class="textbox"><input class="textbox-text validatebox-text textbox-prompt" type="password" name="user.password"
                                                value="<s:property value="user.password"/>"></div>
                </div>
                <div class="formgourp">
                    <label>状态：</label>
                    <div class="textbox">
